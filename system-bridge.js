...
window.addEventListener('DOMContentLoaded', () => {
    ...
    setupGalaxyTrigger();  // Active les 4 clics sur l'anomalie
});
...
function isReleased(itemDate) {
    ...
    // Si on est en mode Master, on ignore la restriction de date pour tout voir

/**
* SYSTEM_BRIDGE_V2026 - SECURED LINK
* Gère la navigation Galaxie, les accès Master/Invité et le Chat Secret.
*/
...
const STATE = {
    ...
    filter: null,
    // On initialise les 4 premiers avec tes données exactes
    romans: [
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    setupSecretTrigger();  // Active les 4 clics sur l'horloge
    setupGalaxyTrigger();  // Active les 4 clics sur l'étoile
});
    ...
    if (trigger) {
        trigger.addEventListener('click', () => {
            ...
            if (secretClickCount === 4) {
                ...
                location.reload(); // Recharge pour appliquer les droits
            }
        });
    }
}
...
function isReleased(itemDate) {
    ...
    return new Date() >= new Date(itemDate);
}
